    ...
    dialects: [
      {
        ...
        native: "English (US)",
        sample: "Hi, I'm Judith! I'll remind you before every bill is due.",
        desc: "Neutral · coast-to-coast",
        sttCode: "en",
      },
      {
        code: "en-US-CA",
        label: "Californian",
        native: "English (California)",
        sample: "Hey, I'm Judith! I'll totally remind you before any bill's due — for sure.",
        desc: "West Coast · laid-back",
        sttCode: "en",
      },
      {
        code: "en-US-TX",
        label: "Texan",
        native: "English (Texas)",
        sample: "Hey y'all, I'm Judith. I'll remind you before every bill comes due, I promise.",
        desc: "Southern · warm y'all energy",
        sttCode: "en",
      },
      {
        code: "en-US-MA",
        label: "Boston",
        native: "English (New England)",
        sample: "Hi, I'm Judith. I'll remind you before every bill's due — wicked helpful, right?",
        desc: "New England · sharp & direct",
        sttCode: "en",
      },
      {
        code: "en-US-NY",
        ...
        sample: "Hey, I'm Judith! I'll remind you before every bill's due — that's just how we do it here.",
        desc: "Northeast · bold & fast-talking",
        sttCode: "en",
      },
      {
        code: "en-US-GA",
        label: "Southern",
        native: "English (Deep South)",
        sample: "Hey there, I'm Judith. I'll remind you before every bill comes due — bless your heart, I've got you covered.",
        desc: "Deep South · warm & unhurried",
        sttCode: "en",
      },
      {
        code: "en-US-MW",
        label: "Midwest",
        native: "English (Heartland)",
        sample: "Hi there, I'm Judith! I'll remind you before every bill's due — ope, don'tcha worry about a thing.",
        desc: "Heartland · friendly & grounded",
        sttCode: "en",
      },
      {
        code: "en-US-SV",
        label: "Valley / SoCal",
        native: "English (Southern California)",
        sample: "Oh my gosh, hi! I'm literally Judith, and I will totes remind you before, like, any bill is due.",
        desc: "Southern Cal · bubbly & upbeat",
        sttCode: "en",
      },
    ],
  },
