...
const SAMPLES_PH: OBSample[] = [
  { group: 0, provider: "Ayala Land",    cat: "Rent / Mortgage", subtype: "Rent", icon: "home",       amount: 18000, due: "1st",  dueDays: 1,  utter: "My rent, 18,000, due every 1st.",                        toks: ["rent", "18,000", "1st"] },
  { group: 0, provider: "Meralco",       cat: "Electricity",                      icon: "zap",        amount: 3450,  due: "15th", dueDays: 6,  utter: "My Meralco, around 3,450, due every 15th.",              toks: ["Meralco", "3,450", "15th"] },
  { group: 0, provider: "Maynilad",      cat: "Water",                            icon: "droplet",    amount: 890,   due: "22nd", dueDays: 13, utter: "Then Maynilad water, about 890, every 22nd.",             toks: ["Maynilad", "890", "22nd"] },
  ...
  { group: 1, provider: "Netflix",       cat: "TV / Streaming",                   icon: "spark",      amount: 549,   due: "5th",  dueDays: 25, utter: "Netflix, 549, on the 5th.",                             toks: ["Netflix", "549", "5th"] },
...
const SAMPLES_US: OBSample[] = [
  { group: 0, provider: "Your Landlord",  cat: "Rent / Mortgage", subtype: "Rent", icon: "home",       amount: 1800, due: "1st",  dueDays: 1,  utter: "My rent, 1,800, due the 1st.",                          toks: ["rent", "1,800", "1st"] },
  { group: 0, provider: "PG&E",           cat: "Electricity",                      icon: "zap",        amount: 120,  due: "15th", dueDays: 6,  utter: "My PG&E, around 120, due the 15th.",                   toks: ["PG&E", "120", "15th"] },
  { group: 0, provider: "Local utility",  cat: "Water",                            icon: "droplet",    amount: 55,   due: "22nd", dueDays: 13, utter: "Water bill, around 55, every 22nd.",                   toks: ["water", "55", "22nd"] },
  { group: 0, provider: "Xfinity",        cat: "Internet",                         icon: "wifi",       amount: 79,   due: "5th",  dueDays: 25, utter: "My Xfinity internet, 79, on the 5th.",                 toks: ["Xfinity", "79", "5th"] },
  { group: 1, provider: "AT&T",           cat: "Mobile",                           icon: "smartphone", amount: 65,   due: "18th", dueDays: 8,  utter: "My AT&T phone plan, 65, every 18th.",                  toks: ["AT&T", "65", "18th"] },
  { group: 1, provider: "Netflix",        cat: "TV / Streaming",                   icon: "spark",      amount: 16,   due: "5th",  dueDays: 25, utter: "Netflix, 16 dollars, on the 5th.",                     toks: ["Netflix", "16", "5th"] },
...
const SAMPLES_SG: OBSample[] = [
  { group: 0, provider: "Your Landlord", cat: "Rent / Mortgage", subtype: "Rent", icon: "home",       amount: 2500, due: "1st",  dueDays: 1,  utter: "My rent, 2,500, due the 1st.",                             toks: ["rent", "2,500", "1st"] },
  { group: 0, provider: "SP Group",     cat: "Electricity",                       icon: "zap",        amount: 120,  due: "15th", dueDays: 6,  utter: "SP Group bill, around 120, due the 15th.",                 toks: ["SP Group", "120", "15th"] },
  { group: 0, provider: "PUB",          cat: "Water",                             icon: "droplet",    amount: 35,   due: "22nd", dueDays: 13, utter: "PUB water, around 35, every 22nd.",                        toks: ["PUB", "35", "22nd"] },
  { group: 0, provider: "Singtel",      cat: "Internet",                          icon: "wifi",       amount: 50,   due: "5th",  dueDays: 25, utter: "My Singtel fibre, 50 dollars, on the 5th.",                toks: ["Singtel", "50", "5th"] },
  { group: 1, provider: "StarHub",      cat: "Mobile",                            icon: "smartphone", amount: 45,   due: "18th", dueDays: 8,  utter: "StarHub mobile, 45 dollars, every 18th.",                  toks: ["StarHub", "45", "18th"] },
  { group: 1, provider: "Netflix",      cat: "TV / Streaming",                    icon: "spark",      amount: 13,   due: "5th",  dueDays: 25, utter: "Netflix, 13 dollars, on the 5th.",                         toks: ["Netflix", "13", "5th"] },
...
const SAMPLES_AU: OBSample[] = [
  { group: 0, provider: "Your Landlord",   cat: "Rent / Mortgage", subtype: "Rent", icon: "home",       amount: 2200, due: "1st",  dueDays: 1,  utter: "My rent, 2,200, due the 1st.",                          toks: ["rent", "2,200", "1st"] },
  { group: 0, provider: "AGL",             cat: "Electricity",                      icon: "zap",        amount: 180,  due: "15th", dueDays: 6,  utter: "AGL electricity, around 180, due the 15th.",            toks: ["AGL", "180", "15th"] },
  { group: 0, provider: "Sydney Water",    cat: "Water",                            icon: "droplet",    amount: 70,   due: "22nd", dueDays: 13, utter: "Sydney Water, around 70, every 22nd.",                  toks: ["Sydney Water", "70", "22nd"] },
  { group: 0, provider: "Telstra",         cat: "Internet",                         icon: "wifi",       amount: 89,   due: "5th",  dueDays: 25, utter: "Telstra internet, 89, on the 5th.",                     toks: ["Telstra", "89", "5th"] },
  { group: 1, provider: "Optus",           cat: "Mobile",                           icon: "smartphone", amount: 55,   due: "18th", dueDays: 8,  utter: "Optus mobile, 55, every 18th.",                         toks: ["Optus", "55", "18th"] },
  { group: 1, provider: "Netflix",         cat: "TV / Streaming",                   icon: "spark",      amount: 18,   due: "5th",  dueDays: 25, utter: "Netflix, 18 dollars, on the 5th.",                      toks: ["Netflix", "18", "5th"] },
...
const SAMPLES_GB: OBSample[] = [
  { group: 0, provider: "Your Landlord",  cat: "Rent / Mortgage", subtype: "Rent", icon: "home",       amount: 1400, due: "1st",  dueDays: 1,  utter: "My rent, 1,400, due the 1st.",                        toks: ["rent", "1,400", "1st"] },
  { group: 0, provider: "British Gas",    cat: "Electricity",                      icon: "zap",        amount: 120,  due: "15th", dueDays: 6,  utter: "British Gas, around 120, due the 15th.",              toks: ["British Gas", "120", "15th"] },
  { group: 0, provider: "Thames Water",   cat: "Water",                            icon: "droplet",    amount: 45,   due: "22nd", dueDays: 13, utter: "Thames Water, around 45, every 22nd.",                toks: ["Thames Water", "45", "22nd"] },
  { group: 0, provider: "BT",             cat: "Internet",                         icon: "wifi",       amount: 40,   due: "5th",  dueDays: 25, utter: "BT broadband, 40 pounds, on the 5th.",                toks: ["BT", "40", "5th"] },
  { group: 1, provider: "EE",             cat: "Mobile",                           icon: "smartphone", amount: 30,   due: "18th", dueDays: 8,  utter: "EE mobile, 30 pounds, every 18th.",                   toks: ["EE", "30", "18th"] },
  { group: 1, provider: "Netflix",        cat: "TV / Streaming",                   icon: "spark",      amount: 11,   due: "5th",  dueDays: 25, utter: "Netflix, 11 pounds, on the 5th.",                     toks: ["Netflix", "11", "5th"] },
...
const SAMPLES_CA: OBSample[] = [
  { group: 0, provider: "Your Landlord",  cat: "Rent / Mortgage", subtype: "Rent", icon: "home",       amount: 2000, due: "1st",  dueDays: 1,  utter: "My rent, 2,000, due the 1st.",                        toks: ["rent", "2,000", "1st"] },
  { group: 0, provider: "BC Hydro",       cat: "Electricity",                      icon: "zap",        amount: 110,  due: "15th", dueDays: 6,  utter: "BC Hydro, around 110, due the 15th.",                 toks: ["BC Hydro", "110", "15th"] },
  { group: 0, provider: "Local municipality", cat: "Water",                        icon: "droplet",    amount: 50,   due: "22nd", dueDays: 13, utter: "Water bill, around 50, every 22nd.",                  toks: ["water", "50", "22nd"] },
  { group: 0, provider: "Bell",           cat: "Internet",                         icon: "wifi",       amount: 85,   due: "5th",  dueDays: 25, utter: "Bell internet, 85, on the 5th.",                      toks: ["Bell", "85", "5th"] },
  { group: 1, provider: "Rogers",         cat: "Mobile",                           icon: "smartphone", amount: 65,   due: "18th", dueDays: 8,  utter: "Rogers mobile, 65, every 18th.",                      toks: ["Rogers", "65", "18th"] },
  { group: 1, provider: "Netflix",        cat: "TV / Streaming",                   icon: "spark",      amount: 17,   due: "5th",  dueDays: 25, utter: "Netflix, 17 dollars, on the 5th.",                    toks: ["Netflix", "17", "5th"] },
  { group: 1, provider: "iCloud+",        cat: "Phone subscription",               icon: "spark",      amount: 4,    due: "1st",  dueDays: 14, utter: "iCloud Plus, 4 dollars, on the 1st.",                 toks: ["iCloud", "4", "1st"] },
  { group: 1, provider: "Microsoft 365",  cat: "Web app",                          icon: "spark",      amount: 10,   due: "9th",  dueDays: 22, utter: "Microsoft 365, 10 dollars, every 9th?",               toks: ["Microsoft", "10", "9th"] },
